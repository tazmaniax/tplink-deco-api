"""Response contract for monthly report generation state."""
...
class MonthlyReportSettingsResponse(ResponseDto):
    """Describe whether monthly report generation is enabled."""
