...
CAPABILITY_ROUTES: tuple[CapabilityRoute, ...] = (
    ...
    CapabilityRoute(
        name="wireless_operation_mode",
        description="Wireless subsystem operation mode",
        sensitivity="private",
        primary_interface="http_luci",
        primary_operation="admin.wireless.operation_mode.read",
        fallback_interface="tmp_appv2",
        fallback_operation="0x40A0",
        fallback_policy="equivalent_read_only",
        equivalence_evidence="p9_live_normalized_field_equivalence",
    ),
    CapabilityRoute(
        name="wireless_bridge",
        description="Wireless bridge and PLC support status",
        sensitivity="private",
        primary_interface="http_luci",
        primary_operation="admin.wireless.bridge.read",
        fallback_interface="tmp_appv2",
        fallback_operation="0x400A",
        fallback_policy="equivalent_read_only",
        equivalence_evidence="p9_live_schema_equivalence",
    ),
    CapabilityRoute(
    ...
    CapabilityRoute(
        ...
        description="System LED and night-mode schedule state",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x401A",
    ...
    CapabilityRoute(
        name="monthly_report_settings",
        description="Monthly report generation state",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x4222",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
        equivalence_evidence="p9_live_schema_contract",
    ...
    CapabilityRoute(
        ...
        description="Monthly client, parental-control, and security reports",
        sensitivity="secret",
        primary_interface="tmp_appv2",
        primary_operation="0x40E0",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
        equivalence_evidence="p9_live_schema_contract",
    ...
    CapabilityRoute(
        name="speed_test_servers",
        description="Speed-test server selection and inventory",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x4228",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
        equivalence_evidence="p9_live_schema_contract",
    ...
    CapabilityRoute(
        name="parental_control_filter_levels",
        description="Default parental-control filtering policies",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x4035",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
        equivalence_evidence="p9_live_schema_contract",
    ...
    CapabilityRoute(
        name="parental_control_catalog",
        description="Website and application filter catalogue",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x403A",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
    ...
    CapabilityRoute(
        name="qos_mode",
        description="Quality-of-service mode details",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x4036",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
        equivalence_evidence="p9_live_schema_contract",
    ...
    CapabilityRoute(
        name="bandwidth_configuration",
        description="Configured upstream and downstream bandwidth limits",
        sensitivity="private",
        primary_interface="tmp_appv2",
        primary_operation="0x4219",
        fallback_interface=None,
        fallback_operation="",
        fallback_policy="none",
        equivalence_evidence="p9_live_schema_contract",
