...
def _read_response_dtos(config: ServerConfig) -> dict[str, ResponseDto]:
    ...
    return {
        ...
        "led_configuration_resource": LedConfigurationResponse(
            schema_version=1,
            status="available",
            enabled=True,
            night_mode={"enabled": True, "time_begin": 1320, "time_end": 420},
            provenance={
                **tmp_provenance,
                "source_operation": "0x401A",
            },
            observed_at_epoch_seconds=1.0,
            router_contacted=True,
            mutation_invoked=False,
        ...
        "mesh_traffic_resource": MeshTrafficResponse(
            schema_version=1,
            status="available",
        ...
        "monthly_report_settings_resource": MonthlyReportSettingsResponse(
            schema_version=1,
            status="available",
            enabled=True,
            provenance={**tmp_provenance, "source_operation": "0x4222"},
            observed_at_epoch_seconds=1.0,
            router_contacted=True,
            mutation_invoked=False,
        ),
        "monthly_reports_resource": MonthlyReportsResponse(
            schema_version=1,
            status="available",
            reports=[
                {
                    "year": 2026,
                    "month": 6,
                    "daily_clients": {"client_counts": [], "new_clients": []},
                    "parental_control": {"has_app_filter": False, "owners": []},
                    "security": {"issues": []},
                }
            ],
            report_count=1,
        ...
        "notifications_resource": NotificationsResponse(
            schema_version=1,
            status="available",
            notifications=[
                {
                    ...
                    "content": {"month": "06", "year": "2026"},
                }
            ],
            notification_count=1,
            provenance={**tmp_provenance, "source_operation": "0x4028"},
            observed_at_epoch_seconds=1.0,
            router_contacted=True,
            mutation_invoked=False,
        ),
        "speed_test_servers_resource": SpeedTestServersResponse(
            schema_version=1,
            status="available",
            automatic_selection=True,
            servers=[],
            server_count=0,
            provenance={**tmp_provenance, "source_operation": "0x4228"},
            observed_at_epoch_seconds=1.0,
            router_contacted=True,
            mutation_invoked=False,
        ),
        ...
        "qos_resource": QosResponse(
            schema_version=1,
            status="available",
            mode={"custom_detail": [], "custom_detail_count": 0},
            bandwidth={
            ...
            provenance={
                "source_interface": "tmp_appv2",
                "source_operations": ["0x4036", "0x4219"],
                "single_source_interface": True,
                "capabilities": {
                    "qos_mode": {**tmp_provenance, "source_operation": "0x4036"},
                    "bandwidth_configuration": {
                        **tmp_provenance,
                        "source_operation": "0x4219",
                    },
                },
            },
            observed_at_epoch_seconds=1.0,
        ...
        "ipv4_configuration_resource": Ipv4ConfigurationResponse(
            schema_version=1,
            status="available",
            wan={
                "ip": "198.51.100.10",
            ...
            provenance={
                "source_interface": "http_luci",
                "source_operation": "admin.network.wan_ipv4.read",
                "fallback_used": False,
                "fallback_policy": "equivalent_read_only",
...
def test_openapi_contract_lists_the_complete_versioned_surface() -> None:
    ...
    expected_operations = {
        ...
        ("/api/v1/notifications", "get"): "getNotifications",
        ("/api/v1/speed-test/servers", "get"): "getSpeedTestServers",
        ...
        ("/api/v1/network/ipv4", "get"): "getIpv4Configuration",
    ...
    expected_response_models = {
        ...
        ("/api/v1/notifications", "get"): "NotificationsResponse",
        ("/api/v1/speed-test/servers", "get"): "SpeedTestServersResponse",
        ...
        ("/api/v1/network/qos", "get"): "QosResponse",
        ...
        ("/api/v1/network/ipv4", "get"): "Ipv4ConfigurationResponse",
...
async def test_mcp_resources_and_rest_routes_serialize_shared_results_identically() -> None:
    ...
    pairs = (
        ...
        (
            ...
            "/api/v1/reports/monthly/settings",
        ),
        (
        ...
        (
            "speed_test_servers_resource",
            "deco://speed-test/servers",
            "/api/v1/speed-test/servers",
        ),
        (
        ...
        ("qos_resource", "deco://network/qos", "/api/v1/network/qos"),
    ...
    with ExitStack() as stack:
        ...
        with TestClient(application) as client:
            responses = (
                ...
                client.get("/api/v1/notifications", headers=_AUTH),
                client.get("/api/v1/speed-test/servers", headers=_AUTH),
